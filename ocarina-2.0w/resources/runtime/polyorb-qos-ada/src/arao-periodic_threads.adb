...
package body ARAO.Periodic_Threads is
   ...
   is
      --  The `The_Create_Thread' pointer should have been correcly
      --  set even by a non tasking profile or by a full tasking
      --  profile.

      pragma Assert (The_Create_Thread /= null);

   begin
      The_Create_Thread.all (TP, Priority, Storage_Size);
