...
package body Ocarina.Backends.Ada_Tree.Nodes is
   ...
   begin
      pragma Assert (False
        ...
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation
   ...
   begin
      pragma Assert (False
        ...
        or else Table (Types.Node_Id (N)).Kind = K_Annotation_list);
   ...
   function SPARK_Own_Annotations (N : Node_Id) return List_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Package_Specification);

      return List_Id (Table (Types.Node_Id (N)).L (7));
   end SPARK_Own_Annotations;

   procedure Set_SPARK_Own_Annotations (N : Node_Id; V : List_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_Package_Specification);

      Table (Types.Node_Id (N)).L (7) := Int (V);
   end Set_SPARK_Own_Annotations;
   ...
   function Own_Mode (N : Node_Id) return Mode_Id is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation);

      return Mode_Id (Table (Types.Node_Id (N)).O (3));
   end Own_Mode;

   procedure Set_Own_Mode (N : Node_Id; V : Mode_Id) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation);
   ...
   function Is_Initialized (N : Node_Id) return Boolean is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation);
   ...
   procedure Set_Is_Initialized (N : Node_Id; V : Boolean) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation);

      Table (Types.Node_Id (N)).B (1) := Boolean (V);
   end Set_Is_Initialized;

   function Is_Protected (N : Node_Id) return Boolean is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation);
   ...
   procedure Set_Is_Protected (N : Node_Id; V : Boolean) is
   begin
      pragma Assert (False
        or else Table (Types.Node_Id (N)).Kind = K_SPARK_Own_Annotation);

      Table (Types.Node_Id (N)).B (2) := Boolean (V);
   end Set_Is_Protected;
      ...
      case Kind (N) is
         ...
         when K_Object_Instantiation =>
            W_Object_Instantiation
              (Node_Id (N));
         when K_Annotation_list =>
            W_Annotation_list
              (List_Id (N));
         when K_SPARK_Own_Annotation =>
            W_SPARK_Own_Annotation
              (Node_Id (N));
         when K_Boolean =>
            W_Boolean
              (Base_Type (N));
   ...
   begin
      ...
      W_Node_Attribute
        ("SPARK_Own_Annotations",
         "List_Id",
         Image (SPARK_Own_Annotations (N)),
         Int (SPARK_Own_Annotations (N)));
      W_Node_Attribute
        ("Withed_Packages",
         "List_Id",
   ...
   procedure W_Annotation_list (N : List_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Last_Node",
         ...
         Image (Last_Node (N)),
         Int (Last_Node (N)));
   end W_Annotation_list;

   procedure W_SPARK_Own_Annotation (N : Node_Id) is
   begin
      W_Node_Header
        (Node_Id (N));
      W_Node_Attribute
      ...
      W_Node_Attribute
        ("Is_Initialized",
         "Boolean",
         Image (Is_Initialized (N)));
      W_Node_Attribute
        ("Is_Protected",
         "Boolean",
         Image (Is_Protected (N)));
   end W_SPARK_Own_Annotation;
