...
package Ocarina.Backends.Ada_Tree.Nodes is
   ...
   procedure W_Annotation_list (N : List_Id);

   --
   --  SPARK_Own_Annotation
   --
   --    Next_Node                : Node_Id
   --    Frontend_Node            : Node_Id
   --    Variable                 : Node_Id
   ...
   procedure W_SPARK_Own_Annotation (N : Node_Id);
   ...
   function SPARK_Own_Annotations (N : Node_Id) return List_Id;
   procedure Set_SPARK_Own_Annotations (N : Node_Id; V : List_Id);
   ...
   function Own_Mode (N : Node_Id) return Mode_Id;
   procedure Set_Own_Mode (N : Node_Id; V : Mode_Id);

   function Is_Initialized (N : Node_Id) return Boolean;
   procedure Set_Is_Initialized (N : Node_Id; V : Boolean);

   function Is_Protected (N : Node_Id) return Boolean;
   procedure Set_Is_Protected (N : Node_Id; V : Boolean);
   ...
   type Byte_Array is array (1 .. 3) of Byte;
